...
from tasks.sincronizar_cliente_siigo import rango_fechas
...
def test_reporte_correo():
    ...
    import tasks.envio_correo
    from tasks import sincronizar_cliente_siigo as mod
    ...
    original_sync, original_delay = mod.SiigoSync, tasks.envio_correo.enviar_correo.delay
    mod.SiigoSync = SyncFalso
    tasks.envio_correo.enviar_correo.delay = lambda **kw: enviados.append(kw)
    try:
        ...
        tasks.envio_correo.enviar_correo.delay = original_delay
